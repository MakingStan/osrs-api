...
public class OsrsApi {
    ...
    public static class Ge
    {
        ...
        //returns everthing in the item json object
        ...
        //returns the url of the large icon
        ...
        //returns the url of the typeicon
        ...
        //returns true if the item is a members item
        ...
        //returns the trend and the price
        ...
        //https://secure.runescape.com/m=itemdb_oldschool/api/catalogue/detail.json?item=577 that's a url of an example. today would return with this url ("trend":"positive","price":"+34") (can change overtime
        ...
        //https://secure.runescape.com/m=itemdb_oldschool/api/catalogue/detail.json?item=577 that's a url of an example. day 30 would return with this url ({"trend":"positive","change":"+6.0%"}) (can change overtime)
        ...
        //https://secure.runescape.com/m=itemdb_oldschool/api/catalogue/detail.json?item=577 that's a url of an example. day 90 would return with this url ("trend":"positive","change":"+12.0%") (can change overtime)
        ...
        //https://secure.runescape.com/m=itemdb_oldschool/api/catalogue/detail.json?item=577 that's a url of an example. day 180 would return with this url ("trend":"positive","change":"+12.0%") (can change overtime)
    ...
    public static class RealTimePrices {
        ...
        //the highest price, the price where is was instabought at
        ...
        //no idea what this does or means, but i just saw it in the json data so i figures i would set it here, if anyone would need it
        ...
        //the lowest price, the price where it was instasold at
